...
if [ ! -f "YearPredictionMSD" ]; then
	wget --no-check-certificate https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/regression/YearPredictionMSD.bz2
...
if [ ! -f "YearPredictionMSD.t" ]; then
	wget --no-check-certificate https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/regression/YearPredictionMSD.t.bz2
